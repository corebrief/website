      ...
      <div className="w-full px-4 py-16 bg-muted/20">
        <div className="mx-auto max-w-4xl flex flex-col items-center text-center">
          ...
          <div className="space-y-8 w-full max-w-4xl">
            {/* CoreBrief Equities */}
            <div className="bg-card border rounded-lg p-6 flex gap-6 items-start shadow-sm hover:shadow-md transition-all duration-200">
              <div className="w-16 h-16 bg-green-50 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            {/* CoreBrief REITs */}
            <div className="bg-card border rounded-lg p-6 flex gap-6 items-start shadow-sm hover:shadow-md transition-all duration-200">
              <div className="w-16 h-16 bg-blue-50 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            {/* CoreBrief MLPs */}
            <div className="bg-card border rounded-lg p-6 flex gap-6 items-start shadow-sm hover:shadow-md transition-all duration-200">
              <div className="w-16 h-16 bg-purple-50 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
